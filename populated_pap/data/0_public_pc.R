...
# Content: Since 2019, the Avohilmo registry also contains private outpatient 
#         care which we want to be excluded from this study.
rm(list=ls())
...
# Inputs:
input_topi = "W:/ASMA4/data/raw/topi_unit_register_2022_06.csv"
input_sote = "W:/ASMA4/data/raw/sote_2022_02.xlsx"
input_contacts = "W:/ASMA4/data/interim/pc_contacts_20" # pc_contacts_20XX.csv, XX in 21:22
input_visits = "W:/ASMA4/data/interim/pc_visits_20" # pc_visits_20XX.csv, XX in 21:22

# Outputs:
output_contacts = "W:/ASMA4/data/interim/pc_contacts_public_20" # pc_contacts_public_20XX.rds, XX in 21:22
output_visits = "W:/ASMA4/data/interim/pc_visits_public_20" # pc_visits_public_20XX.rds, XX in 21:22
...
# Take years from 2021 and drop providers from the Åland Islands:
topi =  topi[year >= 2021 & !(municipality_code %in% to_drop)]


# When extracting the primary care units, we observe 256 and 238 municipalities 
...
orgs = c(
  'Kymoste', 'Kymote', 'Kymsote', 'KYmsote', 'Haminan kaupunki', # KYMENLAAKSO
  'Kotkan hyvinvointipalvelut', 'Kotkan kaupunki', 
  'Kouvolan hyvinvointipalvelut', 'Kouvolan kaupunki', 
  'Kouvolan terveyspalvelut', 'Miehikkälän sosiaali- ja terveystoimi',
  'Pyhtään kunta', 'Virolahden kunta',
    
  'Etelä-Karjalan sosiaali- ja tefrveyspiiri', # SOUTH KARELIA
  'Etelä-Karjalan sosiaali- ja terveyspiiri',
  'Etelä-Karjalan sosiaali- ja tervyspiiri',
  'Etelä-Karjalan sosiaali ja terveyspiiri', 'Imatran kaupunki',
  'Lappeenrannan Kaupunki', 'Lemin kunta', 'Luumäen kunta', 'Parikkalan kunta', 
  'Rautjärven kunta', 'Ruokolahden kunta', 'Savitaipaleen kunta', 
  'Taipalsaaren kunta',
    
  'Harjun terveys Oy', 'PHHYKY', 'Asikkalan kunta', # PÄIJÄT-HÄME
  'Hartolan kunta', 'Hollolan kunta', 'Kärkölän kunta', 'Lahden kaupunki',
  'Lahden Sosiaali- ja terveystoimiala', 'Myrskylän kunta', 
  'Orimattilan Kaupunki', 'Padasjoen kunta', 'Peruspalvelukeskus Oiva',
  'Peruspalvelukeskus Oiva -liikelaitos', 'Pukkilan kunta', 'Iitin kunta'
)
...
# 0.06% of the rows do not contain sote_code, and in 0.1% of the rows the
...
# All rows contain topi_code, but in 3% of the rows the linking did not work.
# 0.02% of the rows do not contain sote_code, and in 0.2% of the rows the
# linking did not work.
...
test = contacts[, .(pc = as.integer(topi_pc == 1 | sote_pc == 1),
                  year)]
summary(test[year==2021]$pc) 
summary(test[year==2022]$pc) 
