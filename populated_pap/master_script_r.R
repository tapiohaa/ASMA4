...
#             sote_2022_02.xlsx + 
#             pc_contacts_20XX.csv  (XX in 21:22) + 
#             pc_visits_20XX.csv (XX in 21:22)
#     Outputs: pc_visits_public_20XX.rds (XX in 21:22) + 
#             pc_contacts_public_20XX.rds (XX in 21:22)
...
#     Input: rct_data.csv + folk_data_2020.csv +
#           pc_contacts_public_20XX.rds (XX in 21:22) +
#           pc_visits_public_20.rds (XX in 21:22) +
#           prescriptions_X.csv (X in 1:3) + 
#           referrals_20XX.csv (XX in 21:22)
...
#           analysis_data_aggr.rds + outcome_trends_dynamic.pdf
